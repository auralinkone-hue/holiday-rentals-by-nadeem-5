...
const ICON_WHATSAPP = 'assets/icons/whatsapp-icon.svg';
const ICON_INSTAGRAM = 'assets/icons/instagramicon.svg';
      ...
      <div class="property-body">
        ...
        <div class="property-actions">
          <a class="btn btn-whatsapp-solid" href="${whatsappUrl(property.name)}" target="_blank" rel="noopener">
            <img src="${ICON_WHATSAPP}" class="btn-icon btn-icon-white" alt="" aria-hidden="true">Book on WhatsApp
          </a>
